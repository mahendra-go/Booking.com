...
//   const [selectionPhase, setSelectionPhase] = useState('departure'); // 'departure' or 'return'
...
//     if (selectionPhase === 'departure') {
//       setDepartureDate(date);
//       setReturnDate(null);
//       setSelectionPhase('return');
//     } else {
//       // Only set return date if it's after departure date
//       if (date > departureDate) {
//         setReturnDate(date);
//         setIsOpen(false);
//         setSelectionPhase('departure');
//       } else {
//         // Show error or automatically select the next day
...
//               : `Select return date (after ${formatDate(departureDate)})`}
//           </div>
